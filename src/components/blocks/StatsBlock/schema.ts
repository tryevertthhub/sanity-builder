    ...
    export const statsBlock = defineType({
      ...
      fields: [
        ...
        defineField({
          ...
          initialValue: "Numbers that demonstrate our commitment to excellence and client success."
        }),
        defineField({
          name: "stats",
          type: "array",
          ...
          initialValue: [
            ...
            },
            {
              ...
              description: "Decades of expertise in financial planning and wealth management."
            },
            {
              _key: "stat3",
              value: "98%",
            ...
            },
            {
              ...
              description: "Helping individuals and families achieve their financial goals."
            }
          ],
